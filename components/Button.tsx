...
export const handleButtonHierarchy = (hierarchy: ButtonHierarchy) => {
  switch (hierarchy) {
    case "primary":
      return "bg-primary-600 hover:bg-primary-700 text-white focus:ring-4 focus:ring-primary-100 disabled:bg-primary-200 shadow-xs rounded-lg";
    case "secondary":
      return "bg-primary-50 hover:bg-primary-100 text-primary-700 focus:ring-4 focus:ring-primary-100 disabled:bg-primary-25 disabled:text-primary-300 shadow-xs rounded-lg";
    case "secondary-gray":
    ...
    case "tertiary":
      return "bg-white text-primary-700 hover:bg-primary-50 disabled:text-gray-300 disabled:hover:bg-white rounded-lg shadow-xs";
    case "tertiary-gray":
      return "bg-white text-gray-500 hover:bg-gray-50 hover:text-gray-600 disabled:text-gray-300 disabled:hover:bg-white rounded-lg";
    default:
      Absurd;
  }
};
